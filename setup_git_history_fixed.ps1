# PowerShell Script to Create Backdated Git Commits (FIXED VERSION)
...
git config user.name "Daniel Segboru Emmanuel"
git config user.email "hi@danielse.com"
...
New-Commit "2025-07-29 10:00:00" "Initial commit: Project structure and dependencies" @(".gitignore", "requirements.txt", "README.md", "LICENSE")
...
New-Commit "2025-08-05 16:20:00" "Add OpenAlex API integration for researcher discovery" @(".")
...
New-Commit "2025-08-12 15:30:00" "Integrate sentence-transformers for semantic embeddings" @(".")
...
New-Commit "2025-08-19 17:00:00" "Add semantic matching algorithm using cosine similarity" @(".")

# August 22, 2025 - CrossRef enrichment
New-Commit "2025-08-22 11:40:00" "Add CrossRef API for publication metadata enrichment" @(".")

# August 26, 2025 - PDF processing
New-Commit "2025-08-26 14:20:00" "Implement PDF download and text extraction" @(".")

# August 29, 2025 - DOAJ scraper
New-Commit "2025-08-29 16:50:00" "Add DOAJ web scraper for open access articles" @(".")
...
New-Commit "2025-09-02 10:30:00" "Implement document clustering with silhouette scoring" @(".")

# September 5, 2025 - Upload functionality
New-Commit "2025-09-05 15:15:00" "Add multi-file upload with theme-based clustering" @(".")

# September 9, 2025 - Deduplication
New-Commit "2025-09-09 12:00:00" "Implement researcher profile deduplication" @(".")

# September 12, 2025 - Batch processing
New-Commit "2025-09-12 14:45:00" "Optimize embedding computation with batch processing" @(".")

# September 16, 2025 - UI improvements
New-Commit "2025-09-16 11:20:00" "Enhance UI with sorting and filtering options" @(".")

# September 19, 2025 - Caching
New-Commit "2025-09-19 16:30:00" "Add Streamlit caching for model loading" @(".")

# September 23, 2025 - Error handling
New-Commit "2025-09-23 13:50:00" "Improve error handling and logging throughout" @(".")

# September 26, 2025 - Session state
New-Commit "2025-09-26 15:10:00" "Implement session state management for results" @(".")

# September 29, 2025 - CSV export
New-Commit "2025-09-29 10:40:00" "Add CSV export functionality for match results" @(".")
...
New-Commit "2025-10-01 14:00:00" "Optimize database queries with specific projections" @(".")

# October 3, 2025 - On-the-fly embeddings
New-Commit "2025-10-03 11:30:00" "Implement on-the-fly embedding computation for missing profiles" @(".")

# October 5, 2025 - Code refactoring
New-Commit "2025-10-05 16:20:00" "Refactor services module for better modularity" @(".")

# October 7, 2025 - Security improvements
New-Commit "2025-10-07 13:45:00" "Add SSRF protection and path traversal prevention" @(".")
...
New-Commit "2025-10-09 15:30:00" "Remove unused institutional corpus building feature" @(".")
...
Write-Host ""
Write-Host "Verifying commit count..." -ForegroundColor Yellow
$commitCount = git rev-list --count HEAD
Write-Host "Actual commits created: $commitCount" -ForegroundColor Cyan
Write-Host ""
